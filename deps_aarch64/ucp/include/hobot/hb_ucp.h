...
#define HB_UCP_VERSION_MINOR (0U)
#define HB_UCP_VERSION_PATCH (8U)
...
#define HB_UCP_ALL_BACKENDS                                             \
  HB_UCP_CORE_ANY | HB_UCP_BPU_CORE_0 | HB_UCP_BPU_CORE_1 |             \
      ...
      HB_UCP_PYRAMID_CORE_1 | HB_UCP_PYRAMID_CORE_2 |                   \
      HB_UCP_PYRAMID_CORE_ANY | HB_UCP_ISP_CORE_0 | HB_UCP_ISP_CORE_1 | \
      HB_UCP_ISP_CORE_ANY
...
#define HB_UCP_ISP_CORE_ANY (1ULL << 41)
...
/**
 * Get current running soc name
 * @return const char pointer, which represents the soc name
 */
const char *hbUCPGetSocName();

/**
 * Submit task to Unified Computing Platform with scheduling parameters
...
/**
 * Release a task and its related resources.
 * @param[in] taskHandle: pointer to the task
 * @return 0 if success, return defined error code otherwise
 */
