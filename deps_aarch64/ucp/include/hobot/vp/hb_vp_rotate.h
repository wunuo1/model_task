 ...
 * @param[out] dstImg destination image, which has the same type and format with src, its size is calculated as follows
 ...
 */
int32_t hbVPRotate(hbUCPTaskHandle_t *task, hbVPImage *dstImg,
