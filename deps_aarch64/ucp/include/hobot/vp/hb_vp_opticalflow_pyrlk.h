 ...
 * minEigThreshold：minimum eigen value threshold
 ...
 * 
 * @param[in/out] taskHandle: return a pointer represent the task if success
 * @param[in/out] currPoints: pointer to the output key points array
 * @param[in/out] currPointsStatus: output status vector (of unsigned chars)
 * @param[in/out] currPointsConf: optical flow confidence, j5 lkof only（float）
 ...
 * @param[in] lkofParam: OpticalFlowPyrLK parameter
